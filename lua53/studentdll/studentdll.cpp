// studentdll.cpp : 定义 DLL 应用程序的导出函数。
//
...
int __declspec(dllexport) luaopen_studentdll_person(lua_State *L)
{
	// 对象的元表
...
int __declspec(dllexport) luaopen_studentdll_student(lua_State *L)
{
	// 对象的元表
